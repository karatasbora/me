...
const resumeData = {
  ...
  experience: [
    {
      ...
      company: {
        tr: "Anadolu Üniversitesi | Öğrenme Teknolojileri Ar-Ge Birimi",
        en: "Anadolu University | Learning Technologies R&D Unit",
      },
    ...
    {
      role: {
        tr: "İngilizce Öğretmeni (Stajyer)",
        en: "English Teacher (Intern)",
      },
      company: {
        tr: "T.C. Millî Eğitim Bakanlığı | Gülay Kanatlı Ortaokulu",
        en: "Ministry of National Education | Gülay Kanatlı Secondary School",
      },
  ...
  education: [
    ...
    {
      degree: {
        tr: "Anglo-Amerikan Çalışmaları",
        en: "Anglo-American Studies",
      },
  ...
  skills: {
    tr: [
      "Eğitimde Yapay Zekâ",
      "Eğitsel İçerik için Prompt Mühendisliği",
      "Öğretim Tasarımı & Öğrenme Deneyimi Tasarımı (LXD)",
      "Öğrenme Yönetim Sistemleri (LMS)",
      "İçerik Yönetim Sistemleri",
      "Dijital Arşivleme & Bilgi Organizasyonu",
      "Akademik Araştırma & Analiz",
      "Sistem Düşüncesi",
    ],
    en: [
      ...
      "Digital Archiving & Knowledge Organization",
  ...
  languages: [
    {
      ...
      level: {
        tr: "Ana Dili / Editoryal Hakimiyet",
        en: "Native / Editorial Proficiency",
      },
    },
    {
      name: { tr: "İNGİLİZCE", en: "ENGLISH" },
      level: {
        tr: "Tam Profesyonel / C2 (Akademik)",
        en: "Full Professional / C2 (Academic)",
      },
    },
    {
      name: { tr: "PORTEKİZCE", en: "PORTUGUESE" },
      level: {
        tr: "Temel Kültürel Aşinalık",
        en: "Basic Cultural Familiarity",
      },
    },
  ],
};
