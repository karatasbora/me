...
function setupSkillNavigation() {
    ...
    document.body.addEventListener('click', (e) => {
        if (e.target.classList.contains('skill-tag')) {
            ...
            // ---------------------------------------------------------
            // UX FEATURE: Back to Hub
            // If we are inside a Job/School (not summary), 
            // ALWAYS offer a link back to the main Skills Summary.
            // ---------------------------------------------------------
            // Note: 'skills-list' is the ID generated by utils.js for the list container
            const summaryId = 'skills-list'; 
            
            // Check if we are clicking from somewhere other than the summary
            // AND ensure we aren't already linking to it (though targetIds shouldn't have it usually)
            ...
            validTargets.forEach(id => {
                ...
                if (targetEl) {
                    ...
                    if (id === summaryId) {
                        ...
                        // Standard Job/Edu Block extraction
            ...
            // Edge detection: if it goes off-screen right, align right
...
function setupDescriptionToggles() {
    // Delegation: Listen for clicks on the toggle button
    document.body.addEventListener('click', (e) => {
        const toggleBtn = e.target.closest('.desc-toggle');
        if (!toggleBtn) return;

        // Find the description container next to the button
        // HTML Structure: Button -> Div.job-description -> Div.branding-tags
